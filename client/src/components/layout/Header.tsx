      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/programs" className="font-['Montserrat'] font-medium text-gray-800 hover:text-primary transition-all border-b-2 border-transparent hover:border-primary pb-1">Focus Areas</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden">
            <div className="py-3 space-y-3">
              ...
              <Link href="/programs" className="block font-['Montserrat'] font-medium text-gray-800 hover:text-primary px-4 py-2 rounded hover:bg-gray-100">Focus Areas</Link>
