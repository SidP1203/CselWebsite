          ...
          {involvementOptions.map((option, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md p-8 text-center transition-all hover:shadow-lg">
              ...
              <Link
                ...
                className={`${option.buttonColor} ${option.title === "Partner With Us" ? "text-gray-800" : "text-white"} font-['Montserrat'] font-semibold px-6 py-2 rounded ${option.buttonHoverColor} transition-all inline-block`}
              >
                {option.buttonText}
              </Link>
            </div>
