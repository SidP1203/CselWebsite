      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/donate"
              className="bg-primary text-white font-['Montserrat'] font-semibold px-8 py-3 rounded-md hover:bg-red-700 transition-all"
            >
              Donate Now
            </Link>
            <Link
              href="/donate"
              className="bg-gray-800 text-white font-['Montserrat'] font-semibold px-8 py-3 rounded-md hover:bg-gray-700 transition-all"
            >
